...
public final class zv1 implements ar0, ti2 {

    /* renamed from: s */
    public static final /* synthetic */ zv1 f16336s = new zv1();

    /* renamed from: t */
    public static final fu0 f16337t = new fu0(0);

    /* renamed from: u */
    public static final /* synthetic */ zv1 f16338u = new zv1();
    ...
    public static b5 e(dd ddVar, boolean z10, boolean z11) {
        if (z10) {
            g(3, ddVar, false);
        }
        String B = ddVar.B((int) ddVar.u(), bu1.f6617b);
        long u10 = ddVar.u();
        String[] strArr = new String[(int) u10];
        for (int i10 = 0; i10 < u10; i10++) {
            strArr[i10] = ddVar.B((int) ddVar.u(), bu1.f6617b);
        }
        if (!z11 || (ddVar.q() & 1) != 0) {
            return new b5(B, strArr);
        }
        throw mq.a("framing bit expected to be set", null);
    }
    ...
    public static boolean g(int i10, dd ddVar, boolean z10) {
        if (ddVar.zza() < 7) {
            if (z10) {
                return false;
            }
            ...
            throw mq.a(valueOf.length() != 0 ? "expected header type ".concat(valueOf) : new String("expected header type "), null);
        } else if (ddVar.q() == 118 && ddVar.q() == 111 && ddVar.q() == 114 && ddVar.q() == 98 && ddVar.q() == 105 && ddVar.q() == 115) {
            return true;
        } else {
            if (!z10) {
                throw mq.a("expected characters 'vorbis'", null);
            }
            return false;
        }
    }
